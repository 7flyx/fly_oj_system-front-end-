  ...
  <el-container class="layout-container">
    <el-header class="el-header">
        <el-dropdown placement="bottom-end" @command="handleCommand">
            ...
            <template #dropdown>
            <el-dropdown-menu>
                <el-dropdown-item command="logout" @click="logout" :icon="SwitchButton">退出登录</el-dropdown-item>
            </el-dropdown-menu>
            </template>
        </el-dropdown>
    </el-header>
    <el-main class="layout-bottom-box">
        ...
        <div class="right">
            <!-- 将二级路由的信息，放在当前这个区域，而不是重新打开一个新的页面 -->
            <RouterView/>
        </div>
    </el-main>
  </el-container>
...
import { getUserInfoService , loginService, logoutService} from '@/apis/suser';
