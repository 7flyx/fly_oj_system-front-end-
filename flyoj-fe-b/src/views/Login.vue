...
<template>
  <div class="login-page">
    ...
    <div class="login-box" v-loading="loading">
      <div class="logo-box">
        <div class="right">
          <div class="sys-name">fly OJ后台管理</div>
          <div class="sys-sub-name">特立西南，学行天下</div>
        </div>
      </div>
      <div class="form-box">
        <div class="form-item">
          <img src="@/assets/images/shouji.png" >
          <el-input v-model="userAccoount" placeholder="请输入账号" />
        </div>
        <div class="form-item">
...
async function loginFun() {
    ...
    // if (loginResult.data.code == 1000) { // 登录成功 
    //     // console.log("登录成功");
    //     router.push("/oj/system"); // 跳转页面
